  ...
  return (
    ...
    >
      <div
        ref={chatRef}
        className={cn(
          "flex flex-col bg-background border border-border sm:rounded-lg shadow-md overflow-hidden transition-all duration-250 ease-out sm:absolute sm:w-[90vw] sm:h-[80vh] fixed inset-0 w-full h-full sm:inset-auto",
